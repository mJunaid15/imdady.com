        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">POS Module for Restaurants</h1>
                    <p class="lead">Point Of Sale is a php based web application for small and medium business to manage inventory, sales (with online/offline payments), expenses, customers and warehouses. </p>
                   <!-- <p>Please edit themes/<?=$Settings->theme;?>/admin/views/promotions.php</p> -->
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p>POS by <a href="http://methologik.com">Methologik (Pvt) Ltd</a>.</p>
                    </div>
                </div>
            </div>
        </div>
