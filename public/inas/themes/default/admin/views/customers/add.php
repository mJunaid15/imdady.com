            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <label class="control-label" for="customer_group"><?php echo $this->lang->line('customer_group'); ?></label>
                        ...
                        echo form_dropdown('customer_group', $cgs, $Settings->customer_group, 'class="form-control select" style="width:100%;" required="required"');
                        ?>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group company">
                        ...
                        <?php echo form_input('company', '', 'class="form-control tip"'); ?>
                    </div>
                    ...
                    <div class="form-group">
                        <?= lang('vat_no', 'vat_no'); ?>
                        <?php echo form_input('vat_no', '', 'class="form-control"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang('gst_no', 'gst_no'); ?>
                    ...
                    <?php echo form_input('contact_person', '', 'class="form-control" data-bv-notempty="true"'); ?>
                </div>-->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        if ($Settings->indian_gst) {
                            ...
                            echo form_input('state', '', 'class="form-control"');
                        }
                        ?>
                    </div>
