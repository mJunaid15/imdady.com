    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <label class="control-label" for="customer_group"><?php echo $this->lang->line('customer_group'); ?></label>
                        ...
                        echo form_dropdown('customer_group', $cgs, $customer->customer_group_id, 'class="form-control select"  style="width:100%;" required="required"');
                        ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        echo form_dropdown('price_group', $pgs, $customer->price_group_id, 'class="form-control select"  style="width:100%;"');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group company">
                        ...
                        <?php echo form_input('company', $customer->company, 'class="form-control tip"  required="required"'); ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('address', $customer->address, 'class="form-control"  required="required"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang('city', 'city'); ?>
                        <?php echo form_input('city', $customer->city, 'class="form-control"  required="required"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang('state', 'state'); ?>
                        <?php
            ...
            <div class="form-group">
                ...
                <?= form_input('award_points', set_value('award_points', $customer->award_points), 'class="form-control tip"   required="required"'); ?>
            </div>
