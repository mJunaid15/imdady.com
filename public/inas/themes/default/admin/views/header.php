                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_bank">
                                <a class="dropmenu" href="#">
                                    ...
                                    <span class="text"> <?= lang('Bank'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <!--bank/add-->
                                <!--bank-->
                                <ul>
                                    <li id="bank_add">
                                        <a class="submenu" href="http://imdady.com/inas/querytest/index.php/welcome/bank"target="_blank">        
                                            <i class="fa fa-user-plus"></i>
                                            <span class="text"> <?= lang('Add_bank'); ?></span>
                                        </a>
                                    </li>
                                    <li id="bank_index">
                                        <a class="submenu" href="http://imdady.com/inas/querytest/index.php/welcome/listbank"target="_blank">
                                            <i class="fa fa-users"></i>
                                            <span class="text"> <?= lang('list_bank'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
