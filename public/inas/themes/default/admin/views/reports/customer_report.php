...
<ul id="myTab" class="nav nav-tabs no-print">
    ...
    <li class=""><a href="#deposits-con" class="tab-grey"><?= lang('deposits') ?></a></li>
     <li class=""><a href="#ledger-con" class="tab-grey"><?= lang('ledger') ?></a></li>
</ul>
...
<div class="tab-content">
    ...
    <!--ledger report-->
    <div id="ledger-con" class="tab-pane fade in">
         <div style="margin-top: 5%;margin-left: 35% ">
        <div class="small-box padding1010 blightBlue col-md-6 text-center">
                            <div class="inner clearfix">

    <a href="http://imdady.com/inas/querytest/index.php/welcome?customer=<?php echo $user_id ?>" target="_blank">View Ledger Report</a>
</div>
</div>
