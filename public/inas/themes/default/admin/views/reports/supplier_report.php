...
<ul id="myTab" class="nav nav-tabs no-print">
    ...
    <li class=""><a href="#payments-con" class="tab-grey"><?= lang('payments') ?></a></li>
       <li class=""><a href="#Ledsupp-con" class="tab-grey"><?= lang('ledger') ?></a></li>
</ul>
...
<!--supplier report-->
<div id="Ledsupp-con" class="tab-pane fade in">
      <div style="margin-top: 5%;margin-left: 35% ">
        <div class="small-box padding1010 blightBlue col-md-6 text-center">
                            <div class="inner clearfix">

    <a href="http://imdady.com/inas/querytest/index.php/welcome/supplier?supplier=<?php echo $user_id ?>" target="_blank">View Ledger Report</a>
</div>
</div>
