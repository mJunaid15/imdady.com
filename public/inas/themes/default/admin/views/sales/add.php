                        ...
                        <div id="payments" style="display: none;">
                            <div class="col-md-12">
                                <div class="well well-sm well_1">
                                    ...
                                    <?= lang('Select_bank', 'Select_bank'); ?>
                                    <?php
                                    $bs[''] = lang('select').' '.lang('bank');
                                    if ($bank) {
                                        foreach ($bank as $bank) {
                                            $bs[$bank->id] = $bank->bank_name."-".$bank->account_no;
                                        }
                                    }
                                    ?>
                                    <?= form_dropdown('bank', $bs, set_value('bank'), 'class="form-control tip" id="bank"'); ?>
                ...
                <div id="bottom-total" class="well well-sm" style="margin-bottom: 0;">
                    <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                        <tr class="warning">
                            ...
                            <td><?= lang('grand_total') ?> <span class="totals_val pull-right" id="gtotal">0.00</spazzzn></td>
                        </tr>
                    </table>
                </div>
