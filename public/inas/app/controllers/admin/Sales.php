...
class Sales extends MY_Controller
{
    ...
    public function getSales($warehouse_id = null)
    {
        ...
        $add_payment_link = anchor('admin/sales/add_payment/$1', '<i class="fa fa-money"></i> ' . lang('add_payment'), 'data-toggle="modal" data-target="#myModal"');
         $add_salepayment_link_by_bank = anchor('http://smartmanagerv2.futuregates.sa/querytest/index.php/welcome/Addsalepayment/$1', '<i class="fa fa-money"></i> ' . lang('Add_payment_by_bank'),['target' => '_blank']);
        ...
        <ul class="dropdown-menu pull-right" role="menu">
            ...
            <li>' . $add_salepayment_link_by_bank. '</li>
    ...
    public function add($quote_id = null)
    {
        ...
        if ($this->form_validation->run() == true && $this->sales_model->addSale($data, $products, $payment)) {
            ...
            $this->data['bank'] = $this->sales_model->getaddsalesbanks(); 
