...
<body style="background-color: #f3f3f3; ">
   ...
   <?php
   foreach($sale->result_array() as $sale):
       ?>
       <div class="mt-3" align="center">
            <h2>Customer Name - <?php echo $sale['customer']; ?></h2>
            <br>
            <h3>Reference Number - <?php echo $sale['reference_no'];?></h3>
       </div>
       <?php
    endforeach;
   ?>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="Amount" placeholder="" value="<?php echo $sale['balance']; ?>" name="amount" required>
    <div class="valid-feedback">Valid.</div>
    <div class="invalid-feedback">Please fill out this field.</div>
  </div>
</div>
